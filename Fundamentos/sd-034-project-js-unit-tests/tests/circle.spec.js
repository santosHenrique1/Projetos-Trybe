...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    expect(circle('ola')).toBeUndefined();
    ...
    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência
    expect(parseFloat(circle(7).circumference)).toBeCloseTo(43.96); 
    // Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à área correta para um círculo de raio 3.
    expect(parseFloat(circle(1).area)).toBeCloseTo(3.14);
    // Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3.
    expect(parseFloat(circle(3).area)).toBeCloseTo(28.26);
    expect(parseFloat(circle(3).circumference)).toBeCloseTo(18.84);
    expect(parseFloat(circle(3).radius)).toBeCloseTo(3);
  });
});
